...
export const THEMES: StoreTheme[] = [
  {
    id: "aura", name: "Classic", photoSet: "beauty", premium: true, layout: "grid",
  ...
  {
    id: "drift", name: "Minimal", photoSet: "home", premium: true, layout: "list",
  ...
  {
    id: "muse", name: "Editorial", photoSet: "fashion", premium: true, layout: "editorial",
  ...
  {
    id: "ember", name: "Bold", photoSet: "food", premium: true, layout: "showcase",
  ...
  {
    id: "horizon", name: "Modern", photoSet: "tech", premium: true, layout: "grid",
  ...
  {
    id: "velvet", name: "Luxury", photoSet: "beauty", premium: true, layout: "lookbook",
  ...
  {
    id: "circuit", name: "Tech", photoSet: "tech", premium: true, layout: "editorial",
  ...
  {
    id: "terra", name: "Natural", photoSet: "flowers", premium: true, layout: "list",
  ...
  {
    id: "nova", name: "Showcase", photoSet: "tech", premium: true, layout: "showcase",
