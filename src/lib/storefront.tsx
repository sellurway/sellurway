...
export interface PublicStore {
  id: string; name: string; slug: string; custom_domain: string | null; description: string | null; logo_url: string | null; banner_url: string | null;
...
export function useStoreQuery(identifier: string) {
  const normalized = normalizeHost(identifier);
  const looksLikeDomain = normalized.includes(".");
