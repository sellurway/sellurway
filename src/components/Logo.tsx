...
export function Logo({ className = "", to = "/" }: { className?: string; to?: string }) {
  const gradientId = `sellurway-logo-gradient-${useId().replace(/:/g, "")}`;
  ...
  return (
    <Link to={to} className={`inline-flex items-center gap-2 ${className}`} aria-label="Sellurway home">
      ...
      >
        <defs>
          <linearGradient id={gradientId} x1="16" y1="104" x2="112" y2="24" gradientUnits="userSpaceOnUse">
        ...
        <path d="M25 36h76l8 66c1 7-4 13-12 13H31c-8 0-13-6-12-13l8-66Z" fill={`url(#${gradientId})`} />
